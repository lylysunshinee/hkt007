...
const ESTIMOTE_APP_ID = "anhnh24-topica-edu-vn-s-pr-bua";
const ESTIMOTE_APP_TOKEN = "c1dfe57f416624f8b793cb32edd4174d";
...
const zone1 = new RNEP.ProximityZone(1, "lobby");
...
const zone2 = new RNEP.ProximityZone(1, "conf-room");
...
zone2.onChangeAction = contexts => {
    if (contexts) {
        contexts.map((item) => {
            ...
            if (item.attachments.position) {
                this.requestServerLogin(item.attachments.position)
            }
